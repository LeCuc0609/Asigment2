...
const Home = (props: any) => {
  ...
  return (
    <>
      <div className="trademark" style={{ backgroundImage: 'url("https://bridge294.qodeinteractive.com/wp-content/uploads/2019/12/shop-title-image.jpg")', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
          ...
          {props?.data?.data?.map((data: any) =>
            <div className="grid-item" key={data._id}>
              <div className="grid-item-img">
                <Link to={`/productDeltail`}><img src={data.image} /> </Link>
              </div>
              <div className="eye">
      ...
      <div className="NewArrivals">
        <div className="NewArrivals-img">
          <div className="NewArrivals-img-child">
            <img src="https://bridge294.qodeinteractive.com/wp-content/uploads/2019/12/slider-image-.jpg" />
          </div>
          ...
          <div className="NewArrivals-product-child">
            <div className="grid-item1">
              <div className="grid-item-img1">
                <img src="https://bridge294.qodeinteractive.com/wp-content/uploads/2019/12/shop-image-4.jpg" />
              </div>
              <div className="eye1">
                <i className="fa-solid fa-eye" />
              </div>
            ...
            <div className="grid-item1">
              <div className="grid-item-img1">
                <img src="https://bridge294.qodeinteractive.com/wp-content/uploads/2019/12/shop-image-2.jpg" />
              </div>
              <div className="eye1">
                <i className="fa-solid fa-eye" />
              </div>
